...
router.get("/users/:email", [validarJWT], mostrarUsuarios);
...
router.post("/contacts/notification", [validarJWT], agregarNotificacion);

//Nueva solicitud de contacto
router.delete("/contacts/notification/:id", [validarJWT], eliminarNotificacion);
